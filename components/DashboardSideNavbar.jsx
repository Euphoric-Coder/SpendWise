  ...
  return (
    <div className="h-screen p-6 border shadow-2xl bg-gradient-to-b from-white via-blue-50 to-indigo-50 rounded-3xl flex flex-col items-center space-y-8 font-mono text-gray-800">
      ...
      <div className="mt-auto w-full flex justify-center fixed bottom-12">
        <div className="relative mx-4 px-6 py-4 bg-gradient-to-r from-white to-indigo-50 rounded-2xl shadow-xl hover:shadow-2xl hover:scale-105 transition-transform duration-300 flex items-center gap-4 border border-transparent bg-clip-padding backdrop-filter backdrop-blur-lg">
          {/* User Avatar */}
          <UserButton />
